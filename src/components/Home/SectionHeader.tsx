...
export default function SectionHeader() {
  return (
    <div className="bg-[url('../../public/bg3.jpg')] xl:bg-[url('../../public/bg2.jpg')] bg-no-repeat xl:bg-center xl:bg-cover min-h-[814px]">
      <Navbar />
      <div className="flex flex-row lg:px-32 px-10">
        <div className="felx flex-col max-w-[593px] pt-[79px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <button className="mt-6 md:mt-0 md:ml-10 text-xl border-1 border-superfluid-100 md:text-superfluid-100 py-4 rounded-full md:bg-superfluid-200 bg-superfluid-100 flex items-center font-semibold text-xl leading-6 lg:min-w-[250px] lg:min-h-[52px] justify-center max-w-[250px]">
              Learn more
            </button>
          </div>
        </div>
