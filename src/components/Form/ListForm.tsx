...
export default function ListForm() {
  ...
  const handleUpdateArray = (position: number, value: string) => {
    ...
    <div className="mx-14">
      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-4">
        ...
        <div className="sm:col-span-4 mt-4">
          ...
          <div className="mt-2">
            {listArray.map((value: string, index: number) => (
              <input
                placeholder="fluidsense.lens"
                key={index}
                type="text"
                value={value}
                className="my-2 placeholder:text-gray-300 px-4 block w-full rounded-md border-1 border-superfluid-100 py-1.5  shadow-sm sm:text-sm sm:leading-6 focus:outline-none focus:ring-1 focus:ring-superfluid-100"
